...
- 20937 수신 시 pending 큐에 저장
- 직후(유효 시간 내) 20403 수신 시 아래 3개가 모두 같으면 1건으로 매칭:
  - userId
  - targetId
  - flags(7 bytes)
- 매칭 성공 시 20937.damage를 최종 데미지로 누적
...
- ATTACK 패킷(20403)의 key1 필드(bytes 16..19)를 스킬 타입 ID로 사용한다.
